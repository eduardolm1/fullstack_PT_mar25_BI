...
const peoplesNewArray = []
peoples.forEach(people =>{
    if(people.age >=25){
        peoplesNewArray.push(people)
    }
})
console.log(peoplesNewArray)
// - [ ] 2.- Crea un array con la gente que empieza por J.

const peopleNameJ = []
peoples.forEach(people=>{
    if(people.name.startsWith('J')){
        peopleNameJ.push(people)
    }
})
console.log(peopleNameJ)
...
const oldPeople = []
const filteredPeople= peoples.map(people => {
    if(people.age>=25){
        oldPeople.push(people)
    }
})
...
const oldPeopleJ = []
const filteredPeopleJ = peoples.map(people =>{
    if(people.name.startsWith('J')){
        oldPeopleJ.push(people)
    }
})
console.log(oldPeopleJ)
